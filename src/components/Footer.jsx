...
const Footer = (props) => {
  return (
    <footer className="bg-gradient-to-r from-brown-s via-brown-lg to-brown-xl">
      <div className="mx-auto max-w-7xl overflow-hidden py-10 px-6 sm:py-12 lg:px-8 flex flex-col">
        ...
        <nav
          className="-mb-6 columns-2 flex justify-center sm:space-x-12 text-center"
          aria-label="Footer"
        >
          <div className="pb-6">
            <a
              href="/about"
              className="text-sm text-center leading-6 text-white hover:text-dark-blue"
            >
              Acerca
            </a>
          </div>
