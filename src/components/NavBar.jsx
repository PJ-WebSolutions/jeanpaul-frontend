      ...
      sections: [
        {
          id: "shoes",
          name: "Calzado",
          items: [{ name: "Todo el calzado", href: "/shoe/view-all" }],
        },
      ],
    },
  ],
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="/">
                  <span className="sr-only">Jean Paul Sandals</span>
                  {/* <h1 className="text-4xl font-fugaz text-dark-blue">
                    Jean Paul
                  </h1> */}
                  <img src={logo} className="h-12" alt="Jean Paul" />
                </a>
              </div>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  >
                    ...
                    <span className="sr-only">
                      articulos en carrito, ver carrito
                    </span>
